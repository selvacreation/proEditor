...
base_dir = '/Users/deepa/videoEditor'
...
def trim(request):
    ...
    if request.method == 'POST':
        ...
        if form_type == 'form1':
            ...
            output_file = f'{base_dir}/media/videos/temp.mp4'
...
def bubble(request):
    ...
    if request.method == 'POST':
        ...
        if form_type == 'form1':
                ...
                output_file = f"{base_dir}/media/videos/tempBubble.mp4"
...
def merge(request):
    ...
    if request.method == 'POST':
        ...
        if form_type == 'form1':
                ...
                output_file = f"{base_dir}/media/videos/tempMerge.mp4"
                if(firstAudio):
                    ffmpeg_command = [
                        'ffmpeg',
                        '-y',
...
def elevenLabsTtsApi(Gender,Accent,Text):
    ...
    desPath = f"{base_dir}/media/videos/temp1.mp3"
